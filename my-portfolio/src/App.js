              ...
              <div class="row gutters-60">
                <div class="col-md-4">
                  <div class="thumbnail text-center">
                    ...
                    <div class="progress">
                      <div class="progress-bar" role="progressbar" style={{ width: '80%', backgroundColor: '#7FB7FA' }}>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="thumbnail text-center">
                    ...
                    <h4 class="skill__single-part__title">ADOBE PHOTOSHOP</h4>
                    <div class="progress">
                      <div class="progress-bar" role="progressbar" style={{width: '80%', backgroundColor: '#FFAC1B'}}>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="thumbnail text-center">
                    ...
                    <h4 class="skill__single-part__title">ADOBE PHOTOSHOP</h4>
                    <div class="progress">
                      <div class="progress-bar" role="progressbar" style={{width: '80%', backgroundColor: '#C99AFF'}}>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="team__overlay">
                      <div class="team__overlay__content">
                        <div class="team__single-section--backPage">
                          <h4 style={{paddingLeft: '0;'}} class="team__single-section__name">VIOLET R. PETERS</h4>
                          <p style={{paddingLeft: '0;'}} class="team__single-section__title">FOUNDER</p>
                          ...
                          <div class="progress">
                            <div class="progress-bar" role="progressbar" style={{width: '90%', backgroundColor: '#7F56FD'}}>
                          ...
                          <div class="progress">
                            <div class="progress-bar" role="progressbar" style={{width: '80%', backgroundColor: '#7F56FD'}}>
                              <span class="progress-bar--dot-main"></span>
                              <span class="progress-bar--dot"></span>
                            </div>
                          </div>
                          ...
                          <div class="progress">
                            <div class="progress-bar" role="progressbar" style={{width: '70%', backgroundColor: '#7F56FD'}}>
                              <span class="progress-bar--dot-main"></span>
                              <span class="progress-bar--dot"></span>
                            </div>
                          </div>
                          <hr style={{border: '0', borderBottom: '1px solid #ECEFF1', display: 'block', paddingTop: '45px'}} />
                ...
                <div class="col-md-6 col-lg-3">
                  <div class="thumbnail">
                    ...
                    <div class="team__overlay">
                      <div class="team__overlay__content">
                        <div class="team__single-section--backPage">
                          <h4 style={{paddingLeft: '0'}} class="team__single-section__name">PAULA R. MULLINS</h4>
                          <p style={{paddingLeft: '0'}} class="team__single-section__title">FOUNDER</p>
                          <p class="team__single-section--backPage__title">Adobe Photoshop <span class="team__single-section--backPage__percent90">90&#37;</span></p>
                          <div class="progress">
                            <div class="progress-bar" role="progressbar" style={{ width: '90%', backgroundColor: '#7F56FD;' }}>
                ...
                <div class="col-md-6 col-lg-3">
                  <div class="thumbnail">
                    ...
                    <div class="team__overlay">
                      <div class="team__overlay__content">
                        <div class="team__single-section--backPage">
                          <h4 style={{paddingLeft: '0;'}} class="team__single-section__name">LEONARD D. DOWNING</h4>
                          <p style={{paddingLeft: '0;'}} class="team__single-section__title">FOUNDER</p>
                          <p class="team__single-section--backPage__title">Adobe Photoshop <span class="team__single-section--backPage__percent90">90&#37;</span></p>
                          <div class="progress">
                            <div class="progress-bar" role="progressbar" style={{width:'90%', backgroundColor: '#7F56FD;'}}>
